// src/finance/components/Navbar.jsx
...
export default function Navbar({ onMenuClick, user }) {
  ...
  const openChat = async (notif) => {
    ...
    setNotifOpen(false);
    navigate("/finance/chat", { state: { chatRoomId: notif.id } });
  };
              ...
              >
                ...
                {notifications.length > 0 && (
                  <div className="px-4 py-2.5 border-t border-blue-100">
                    <button
                      onClick={() => { setNotifOpen(false); navigate("/finance/chat"); }}
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              ...
              >
                ...
                <button
                  onClick={() => { setDropdownOpen(false); navigate("/finance/profile"); }}
