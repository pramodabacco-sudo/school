                ...
                <div className="flex items-center gap-2 sm:gap-3 relative z-10">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-white/20 hover:bg-white/30 text-white text-[12px] sm:text-[13px] font-semibold transition-all border border-white/20 whitespace-nowrap"
                        >
                                        ...
                                        <button key={status}
                                            onClick={() => {
                                                ...
                                                downloadStaffSalaryExcel(rows, {
                                                    filter: status,
                                                    groupLabel: "Group D — Admin & Finance Staff",
