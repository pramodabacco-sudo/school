              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: "12px", color: "#6b7280" }}>
                  {hasSections
                    ...
                    : "Single class · add sections if needed"}
                </p>
              </div>
            </div>
            <button
                ...
                <div key={i} style={S.sectionCard}>
                  ...
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      justifyContent: "space-between",
                      marginBottom: collapsed[i] ? 0 : "14px",
                    }}
                  >
                    <div
                      style={{
                    ...
                    >
                      <span style={S.sectionBadge}>
                        Section {sec.name || String.fromCharCode(65 + i)}
                      </span>
                      {sec.teacher && (
                      ...
                      <Row>
                        ...
                        <Field label="Room Number">
                          <input
                            ...
                            value={sec.room}
                            onChange={(e) =>
                              updateSection(i, "room", e.target.value)
                            }
                            onFocus={onFocus}
                            onBlur={onBlur}
                          />
                        ...
                        <Row>
                          <Field label="Class Teacher">
                            <input
                              ...
                              value={sec.teacher}
                              onChange={(e) =>
                                updateSection(i, "teacher", e.target.value)
                              }
                              onFocus={onFocus}
                              onBlur={onBlur}
                            />
                          ...
                          <Field label="Capacity">
                            <input
                              ...
                              value={sec.capacity}
                              onChange={(e) =>
                                updateSection(i, "capacity", e.target.value)
                              }
                              onFocus={onFocus}
                              onBlur={onBlur}
                            />
