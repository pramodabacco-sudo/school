...
export default function ResetPassword() {
  ...
  // identifier is now the phone number
  const identifier =
  ...
  const handleReset = async () => {
    ...
    try {
      await axios.post(`${API_URL}/api/auth/reset-password`, {
        ...
        identifier,             // ← backward compat
        newPassword: password,
      });

      // Clean up stored identifier
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fp-input-match  { border-color: rgba(34,197,94,0.5) !important; background: rgba(34,197,94,0.04) !important; }
        .fp-input-error  { border-color: rgba(239,68,68,0.4) !important; }

        .fp-eye-btn {
          position: absolute; right: 12px; top: 50%;
          transform: translateY(-50%);
          background: none; border: none; cursor: pointer;
          color: #6A89A7; display: flex; align-items: center;
      ...
      <div className="fp-root">
        ...
        <div className="fp-card">
          ...
          <div className="fp-body">
            ...
            {/* Submit */}
            <button className="fp-btn" onClick={handleReset} disabled={!password || !confirm}>
